...
\objective{An engineering graduate passionate about computer architecture design, SW/HW co-design, accelerated computing, HPC, quantum computing, and software engineering. \textbf{Authorized to work for any employer in the US}.}
...
\achievement{\textbf{Frameworks and tools:} RISC-V, Qiskit, PyTorch,
    Tensorflow, REST, AWS, Docker, Vulkan, Synopsys(Design Compiler,
...
\experience{Silicon Validation SW Intern}{Apple Inc.}{May 2024}{Present}{
    \achievement{
        ...
        Internalize hardware coverage PPROC method into testing
        platform to run and provide feedback on-the-fly.
    }
}
...
\experience{Graduate Student Instructor}{EECS 498: Quantum
    ...
    \achievement{
        Redesigned course materials  with lead instructor. Improved project
